...
const Login = () => {
    ...
    return (
        <div className="position-relative min-vh-100 d-flex justify-content-center align-items-center"
             style={{background: "linear-gradient(60deg, #f8fafc, #7c3aed)", border: "none"}}>
            ...
            <div style={{position: "absolute", top: "20px", left: "30px", display: "flex", alignItems: "center"}}>
                <Link to="/" style={{
                    ...
                    <span className="fw-bold fs-4 text-light">AuthSphere</span>
                </Link>
            </div>
                    ...
                    <form onSubmit={onSubmitHandler}>
                        {
                            isCreateAccount && (
                                <div className="mb-3">
                                    <label htmlFor="fullname" className="form-label">Full Nmae</label>
                                    <input
                                        type="text"
                                        id="fullName"
